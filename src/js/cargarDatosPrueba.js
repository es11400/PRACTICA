...
module.exports = {
    ...
    cargar: function(){
		    ...
		    var entrada = {
			    ...
			    fecha 			: (fechaActual.getMonth()+1) + "/" + fechaActual.getDate() + "/" + fechaActual.getFullYear() + " " + fechaActual.getHours() + ":" + (fechaActual.getMinutes()-10) + ":" + fechaActual.getSeconds(),
		    ...
		    var entrada = {
		    	autor 			: "Bugs",
			    imagen_autor	: "",
			    fecha 			: (fechaActual.getMonth()+1) + "/" + fechaActual.getDate() + "/" + fechaActual.getFullYear() + " " + fechaActual.getHours() + ":" + fechaActual.getMinutes() + ":" + (fechaActual.getSeconds()-30),
		    ...
		    var entrada = {
		    	autor 			: 'Carlos Castaño',
			    imagen_autor	: 'avatar_11400es.png',
			    fecha 			: (fechaActual.getMonth()+1) + "/" + fechaActual.getDate() + "/" + fechaActual.getFullYear() + " " + fechaActual.getHours() + ":" + (fechaActual.getMinutes()-2) + ":" + fechaActual.getSeconds(),
		    ...
		    var entrada = {
			    ...
			    imagen_autor	: '',
			    fecha 			: (fechaActual.getMonth()+1) + "/" + fechaActual.getDate() + "/" + fechaActual.getFullYear() + " " + (fechaActual.getHours() - 1) + ":" + fechaActual.getMinutes() + ":" + fechaActual.getSeconds(),
		    ...
		    var entrada = {
		    	autor 			: 'Carlos Castaño',
			    imagen_autor	: 'avatar_11400es.png',
			    fecha 			: (fechaActual.getMonth()+1) + "/" + fechaActual.getDate() + "/" + fechaActual.getFullYear() + " " + (fechaActual.getHours() - 2) + ":" + (fechaActual.getMinutes() - 23) + ":" + fechaActual.getSeconds(),
			    titulo 			: 'Mecano',
		    ...
		    var entrada = {
			    ...
			    imagen_autor	: '',
			    fecha 			: (fechaActual.getMonth()+1) + "/" + fechaActual.getDate() + "/" + fechaActual.getFullYear() + " " + (fechaActual.getHours() - 2)+ ":" + (fechaActual.getMinutes() - 35) + ":" + (fechaActual.getSeconds() - 10),
		    ...
		    var entrada = {
		    	autor 			: 'Mercedes Fernández',
			    imagen_autor	: '',
			    fecha 			: (fechaActual.getMonth()) + "/" + fechaActual.getDate() + "/" + fechaActual.getFullYear() + " " + fechaActual.getHours() + ":" + fechaActual.getMinutes() + ":" + fechaActual.getSeconds(),
		    ...
		    var entrada = {
			    ...
			    imagen_autor	: '',
			    fecha 			: (fechaActual.getMonth()) + "/" + fechaActual.getDate() + "/" + fechaActual.getFullYear() + " " + (fechaActual.getHours() - 10) + ":" + fechaActual.getMinutes() + ":" + fechaActual.getSeconds(),
		    ...
		    var entrada = {
		    	autor 			: 'Pepito Pérez',
			    imagen_autor	: '',
			    fecha 			: (fechaActual.getMonth() - 2) + "/" + fechaActual.getDate() + "/" + fechaActual.getFullYear() + " " + fechaActual.getHours() + ":" + fechaActual.getMinutes() + ":" + fechaActual.getSeconds(),
